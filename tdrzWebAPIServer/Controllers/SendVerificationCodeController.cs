...
namespace tdrzWebAPIServer.Controllers
{
    ...
    public class SendVerificationCodeController : ControllerBase
    {
        ...
        [HttpPost]
        [EnableCors("any")]
        public JsonResult Post([FromBody] SendVerificationCodeInput value)
        {
            try
            {
                var txSendVerificationCode = new SendVerificationCodeTx
                {
                ...
                using (var clientSocket = new Socket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp))
                {
                    ...
                    try
                    {
                        ...
                        #endregion
                        #region AES加密数据
                        var data = JsonConvert.SerializeObject(txSendVerificationCode);
